package com.study.security_joohong.web.dto.auth;
...
public class SignupReqDto {
	...
	public com.study.security_joohong.domain.user.User toEntity() {
		return com.study.security_joohong.domain.user.User.builder()
				.user_name(name)
				.user_email(email)
				.user_id(username)
